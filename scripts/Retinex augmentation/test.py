...
for img_name in img_list:
    ...
    cv2.imwrite(imagename + "MSRCR_retinex.jpg",img_msrcr);
    ...
    cv2.imwrite(imagename +'AutomatedMSRCR_retinex.jpg', img_amsrcr)
    ...
    cv2.imwrite(imagename + 'MSRCP.jpg', img_msrcp)
    #cv2.waitKey()
